...
> ⚠️ **注意**：本文档的**问题 2 / 问题 4-2** 结果已被 **v3 修正**（v1/v2 误将附件 2 的
> "光伏发电实际功率"当作日前计划输入，导致紧急购电恒为 0；正确做法是"计划用附件 1 的**光伏预测**、
> 结算用附件 2 的**实际光伏**"）。修正后的完整文档见
> [`C题_微网与外部电网电力调控策略_完整建模说明文档_v3.md`](C题_微网与外部电网电力调控策略_完整建模说明文档_v3.md)（§4、§16.1）。
> 问题 1 / 3 / 4-3 及 §11–§15 的五项改进结论不受影响。
